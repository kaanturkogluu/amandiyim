        ...
        <div class="store-content">
            ...
            <div class="campaigns-section">
                <div class="section-header">
                    ...
                    <span class="campaign-count">2 Kampanya</span>
                </div>
                <div class="campaigns-grid">
                    ...
                    <div class="campaign-card">
                        ...
                        <div class="campaign-content">
                            ...
                            <p>Seçili ürünlerde %20 indirim fırsatı!</p>
                            <div class="campaign-details">
                                <div class="campaign-date">
                                    <i class="far fa-calendar"></i>
                                    <span>1 Temmuz - 31 Temmuz</span>
                                </div>
                                <div class="campaign-terms" onclick="openTermsModal(1)">
                    ...
                    <!-- Kampanya Kartı 2 -->
                    <div class="campaign-card">
                        <div class="campaign-badge">2 Al 1 Bedava</div>
                        <div class="campaign-content">
                            <h3>Seçili Ürünlerde</h3>
                            <p>Belirli ürünlerde 2 al 1 bedava kampanyası</p>
                            <div class="campaign-details">
                                <div class="campaign-date">
                                    <i class="far fa-calendar"></i>
                                    <span>15 Temmuz - 30 Temmuz</span>
                                </div>
                                <div class="campaign-terms" onclick="openTermsModal(2)">
                                    <i class="fas fa-info-circle"></i>
                                    <span>Kampanya Koşulları</span>
                                </div>
                            </div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="terms-content">
                ...
                <ul>
                    <li>Bu kampanya sadece seçili ürünlerde geçerlidir.</li>
                    <li>İndirim oranı %20'dir.</li>
                    <li>Kampanya 1 Temmuz - 31 Temmuz tarihleri arasında geçerlidir.</li>
